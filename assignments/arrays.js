...
//-1 counts one backwards from 0 which is the begining of the list 
console.log(lastCar.car_make, lastCar.car_model);

// ==== Challenge 3 ====
// The marketing team wants the car models listed alphabetically on the website. Sort all the car model names into alphabetical order and log the results in the console
let carModels = [];
//loop thorough car models
for (let i=0; i<inventory.length; i++)
//set loop to go though car invenory car_model
...
//set loop
for (let i=0; i<inventory.length; i++)
//if statement for cars older than 2000 
if (carYears[i]<2000){
//added selector to array
...
//set loop
for (let i=0; i<inventory.length; i++)
// if statement for BMW and Audi
if(inventory[i].car_make==="BMW"|| inventory[i].car_make==="Audi"){
   //push selector into array
